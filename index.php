...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['shipment'])) {
    header('Content-Type: application/json; charset=utf-8');
    echo json_encode($dhl->getShipment($_GET['shipment']));
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Content-Type: application/json; charset=utf-8');
    echo json_encode($dhl->createShipment($jayParsedAry));
}


// $curl = new \App\Curl\Curl(env('DHL_ENDPOINT_TEST'));
//$curl->get('shipments/12345609/proof-of-delivery');
